                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <h3 className="mt-3">Client Name: <span >{getuserdata.client_name}</span></h3>
                            <p className="mt-3"><MailOutlineIcon />Email: <span>{getuserdata.email}</span></p>
                            <p className="mt-3"><WorkIcon />Start Date: <span>{getuserdata.subscription_start_date}</span></p>
                        </div>
                        <div className="right_view  col-lg-6 col-md-6 col-12">

                            <p className="mt-5"><PhoneAndroidIcon />mobile: <span>+91 {getuserdata.mobile_number}</span></p>
                            <p className="mt-3"><LocationOnIcon />Address: <span>{getuserdata.address}</span></p>
                            <p className="mt-3">End Date: <span>{getuserdata.subscription_end_date}</span></p>
                        </div>
                    </div>
